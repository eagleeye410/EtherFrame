...
#[derive(Debug)]
pub struct EtherFrameProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EtherFrameProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EtherFrame processing");
    
    let mut processor = EtherFrameProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EtherFrameProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EtherFrameProcessor::new(false);
